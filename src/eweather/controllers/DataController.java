...
public class DataController {
    ...
    /**
     * Επιστρέφει τον καιρό για τις πόλεις με τα ID που περιέχονται στο όρισμα
     * της συνάρτησης.
     *
    ...
    /**
     * Επιστρέφει όλα τα δεδομένα καιρού που είναι αποθηκευμένα στην βάση
     * δεδομένων για μια συγκεκριμένη πόλη
     *
    ...
    /**
     * Επιστρέφει τις εγγραφές πρόγνωσης που αφορούν μια πόλη για το διάστημα
     * μιας ημέρας.
     *
     * @param cityId Το ID της πόλης
    ...
    /**
     * Επιστρέφει τις εγγραφές πρόγνωσης που αφορούν μια πόλη για το διάστημα 5
     * ημερών
     *
     * @param cityId Το ID της πόλης
     * @param dt_start Ημερομηνία που αφορά την αρχή των προβλέψεων
